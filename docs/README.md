...
9. [Release notes 0.8.0](release-notes-0.8.0.md)
10. [Release notes 0.7.3](release-notes-0.7.3.md)
11. [Release notes 0.7.2](release-notes-0.7.2.md)
12. [Release notes 0.7.1](release-notes-0.7.1.md)
13. [Release notes 0.7.0](release-notes-0.7.0.md)
...
- `release-notes-0.8.0.md`: latest release changes, QA attachment/capture contract, source inspector updates, and validation scope.
