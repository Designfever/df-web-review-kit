...
Adds custom right-rail panels and automatic issue captures, with a shared image
preview and fixes for assignee menus and issue composer layout.
...
- 311 tests across 60 Vitest files passed.
